...
# Where to save plot
savePlotPath = (
    'ADVERSIAL_GROUP_CALIBRATION_RECALIBRATION_ZOOMED_IN_PLOT_SAVE_FILEPATH_USER_SPECIFIED'
)
...
recalibratedUncertaintyFileNameEnsemble = (
    'IS2RE_all_CGCNN_ValID_Ensemble5_Energy_StdDev_RecalScalar.csv'
)
recalibratedUncertaintyFileNameDropout = (
    'IS2RE_all_CGCNN_ValID_MC_Energy_StdDev1000_RecalScalar.csv'
)
...
for ind in range(len(predictionFilePathList)):
    ...
    recalibratedUncertaintyFilePath = os.path.join(
        uncertaintyFilePathList[ind] + 'recalibration/',
        recalibratedUncertaintyFileNameList[ind],
    )
...
savePlotNameLegTitle = (
    'UQ_Technique_Compare_Overlay_AdvCalibration_Recal_Scalar_LegTitle_Seed'
    + str(rngVisualSeed)
)
savePlotName = 'UQ_Technique_Compare_Overlay_AdvCalibration_Recal_Scalar_Seed' + str(
    rngVisualSeed
)
...
recalibratedUncertaintyNPEnsemble = recalibratedUncertaintyPDList[0][
    uncertaintyColNameEnsemble
].to_numpy()
recalibratedUncertaintyNPDropout = recalibratedUncertaintyPDList[1][
    uncertaintyColNameDropout
].to_numpy()
recalibratedEpistemicUncertaintyNPEvidential = recalibratedUncertaintyPDList[2][
    epistemicUncertaintyColNameEvidential
].to_numpy()
...
make_plots(
    ...
    lineplot_xLabels=None,
    showTitleChoice=True,
    showLegendChoice=False,
    plot_save_str=savePlotFileTitle,
)
make_plots(
    predictionNPList,
    uncertaintyNPList,
    ...
    lineplot_legLabels=None,
    lineplot_xLabels=None,
    showTitleChoice=False,
    showLegendChoice=True,
    plot_save_str=savePlotFileLeg,
)
make_plots(
    predictionNPList,
    uncertaintyNPList,
    ...
    showTitleChoice=True,
    showLegendChoice=True,
    plot_save_str=savePlotFileLegTitle,
)
make_plots(
    predictionNPList,
    uncertaintyNPList,
