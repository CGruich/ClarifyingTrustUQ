...
def make_plots(
    ...
    axs[2][0] = uct.viz_MC_Dropout.plot_parity(
        pred_mean,
        pred_std,
        target,
        subsetCountParity,
    ...
    axs[2][1] = uct.viz_MC_Dropout.plot_parity_hexagonal(
        pred_mean,
        pred_std,
        target,
    ...
    axs[2][2] = uct.viz_MC_Dropout.plot_parity_hexagonal(
        pred_mean,
        pred_std,
        target,
        gridSize=gridSizeCount,
    ...
    axs[1][1] = uct.viz_MC_Dropout.plot_residuals_vs_stds_hexagonal(
        pred_mean,
        pred_std,
        target,
        gridSize=gridSizeCount,
    ...
    # Violin/Box plot
    axs[1][2] = uct.viz_MC_Dropout.plot_violin_box_plot(
        pred_std,
        ylims=None,
        leg_loc=4,
        seed=subsetSeed,
...
lineplotDataArray = np.asarray(
    [
        ...
        (5, 0.656844056111952),
        (10, 0.6692073030924),
        (20, 0.742656429820688),
        (30, 0.890508384605024),
    ],
    dtype='float32',
)
