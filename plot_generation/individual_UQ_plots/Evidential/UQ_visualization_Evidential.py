...
def make_plots(
    ...
    axs[2][1] = uct.viz_Evidential.plot_parity_hexagonal(
        pred_mean,
        pred_std,
        target,
        lamb,
    ...
    axs[2][2] = uct.viz_Evidential.plot_parity_hexagonal(
        pred_mean,
        pred_std,
        target,
        lamb,
    ...
    axs[1][1] = uct.viz_Evidential.plot_residuals_vs_stds_hexagonal(
        pred_mean,
        pred_std,
        target,
        lamb,
    ...
    # Violin + Box plot
    axs[1][2] = uct.viz_Evidential.plot_violin_box_plot(
        pred_std,
        lamb,
        ylims=None,
        leg_loc=4,
...
lineplotDataArray = np.asarray(
    [
        (0.0, 0.633265837888014),
        (0.05, 0.629793262621284),
        (0.1, 0.631996560722256),
        (0.15, 0.632487070559222),
        (0.2, 0.633375750628576),
    ],
    dtype='float32',
)
...
make_plots(
    predictionNP,
    aleatoricUncertaintyNP,
    targetNP,
    lamb,
    rngVisualSeed,
    lineplotDataArray,
    lineplot_legLabels=None,
    lineplot_xLabels=xLabelList,
    showTitleChoice=showTitleChoice,
    showLegendChoice=showLegendChoice,
    plot_save_str=aleatoricSavePlot,
)
make_plots(
    predictionNP,
    epistemicUncertaintyNP,
    targetNP,
    lamb,
    rngVisualSeed,
    lineplotDataArray,
