...
def make_plots(pred_mean, pred_std, target, subsetSeed, lineplot_array=None, lineplot_legLabels=None, lineplot_xLabels=None, showTitleChoice=True, showLegendChoice=True, plot_save_str="row"):
    ...
    axs[0][1] = uct.viz_Ensemble.plot_calibration(
        pred_mean, pred_std, target, seed=subsetSeed, showTitle=showTitleChoice, showLegend=False, ax=axs[0][1])
    ...
    axs[2][0] = uct.viz_Ensemble.plot_parity(pred_mean, pred_std, target, subsetCountParity, leg_loc=4,
    ...
    axs[2][1] = uct.viz_Ensemble.plot_parity_hexagonal(pred_mean, pred_std, target, gridSize=gridSizeCount, subFig=fig,
    ...
    axs[2][2] = uct.viz_Ensemble.plot_parity_hexagonal(pred_mean, pred_std, target, gridSize=gridSizeCount, bins="log", subFig=fig,
                                                       n_subset=None, leg_loc=4, seed=subsetSeed, showTitle=showTitleChoice, showLegend=showLegendChoice, ax=axs[2][2])

    axs[1][1] = uct.viz_Ensemble.plot_residuals_vs_stds_hexagonal(pred_mean, pred_std, target, gridSize=gridSizeCount, bins="log",
                                                                  subFig=fig, n_subset=None, leg_loc=4, seed=subsetSeed, showTitle=showTitleChoice, showLegend=showLegendChoice, ax=axs[1][1])

    # Violin + Box plot
    axs[1][2] = uct.viz_Ensemble.plot_violin_box_plot(pred_std, ylims=None, leg_loc=4, seed=subsetSeed, kdePoints=1000, width=0.5, whiskers=(
        1.0, 99.0), showTitle=showTitleChoice, showLegend=showLegendChoice, showMeans=False, showExtrema=False, showMedians=False, showVertical=True, ax=axs[1][2])
